...
export const getSettings = () => {
    try {
        if (!fs.existsSync(CONFIG_PATH)) {
            ...
            return {
                apiKey: "",
                systemPrompt: "Ты — профессиональный YouTube-сценарист. Твоя задача — создавать виральные сценарии."
            };
        }
...
export const updateSettings = (newSettings) => {
    try {
        ...
        // TODO: Здесь будет вызов фоновой синхронизации с Google Drive
